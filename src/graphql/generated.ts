...
export type CreateSubsrciberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubsrciberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, description?: string | null, availableAt?: any | null, title: string, slug?: string | null }> };


export const CreateSubsrciberDocument = gql`
    mutation CreateSubsrciber($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreateSubsrciberMutationFn = Apollo.MutationFunction<CreateSubsrciberMutation, CreateSubsrciberMutationVariables>;

/**
 * __useCreateSubsrciberMutation__
 *
 * To run a mutation, you first call `useCreateSubsrciberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubsrciberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubsrciberMutation, { data, loading, error }] = useCreateSubsrciberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubsrciberMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubsrciberMutation, CreateSubsrciberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubsrciberMutation, CreateSubsrciberMutationVariables>(CreateSubsrciberDocument, options);
      }
export type CreateSubsrciberMutationHookResult = ReturnType<typeof useCreateSubsrciberMutation>;
export type CreateSubsrciberMutationResult = Apollo.MutationResult<CreateSubsrciberMutation>;
export type CreateSubsrciberMutationOptions = Apollo.BaseMutationOptions<CreateSubsrciberMutation, CreateSubsrciberMutationVariables>;
